              ...
              >
                ...
                >
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full bg-black/20 border border-green-500/30 text-green-300 placeholder:text-green-600/70 focus:border-green-400 focus:ring-1 focus:ring-green-500/30 shadow-[0_0_10px_#22c55e/5] rounded-xl py-3 px-4 transition-all duration-300"
                    />
                  </div>
                </motion.div>
                ...
                >
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      className="w-4 h-4 text-green-500 rounded focus:ring-green-500 bg-black/30 border-green-500/50"
                    />
